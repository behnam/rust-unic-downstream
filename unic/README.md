...
-   [`unic-bidi`](bidi/): Unicode Bidirectional Algorithm
...
-   [`unic-normal`](normal/): Unicode Normalization Forms
...
-   [`unic-segment`](segment/): Unicode Text Segmentation Algorithms
...
-   [`unic-emoji`](emoji/): Unicode Emoji
